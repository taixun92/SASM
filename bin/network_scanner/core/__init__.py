...
def main( args, logger ):
    ...
    if args[ 'command' ] == 'GET_INTERFACES':
        ...
        # with open( 'GET_INTERFACES.json', 'w', encoding='utf-8' ) as f:
        #     f.write( json_dumps(
        ...
        # with open( 'HOST_DISCOVERY.json', 'w', encoding='utf-8' ) as f:
        #     f.write( json_dumps(
        ...
        with open( 'PORT_SCAN.json', 'w', encoding='utf-8' ) as f:
            f.write( json_dumps(
                  out_dict[ 'port_scan_result' ]
                , default      = lambda o: str( o )
                , indent       = 4
                , ensure_ascii = False
            ) )
